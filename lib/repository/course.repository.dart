...
class CourseRepository{
  ...
  int pageSize = 8;
  Future<Lessons> getLessons(int page) async{
    String url = "https://arabic-language.herokuapp.com/api/lessons/?populate=*&pagination[page]=$page&pagination[pageSize]=$pageSize";
    try {
