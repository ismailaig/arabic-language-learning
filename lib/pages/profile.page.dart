...
class _ProfilePageState extends State<ProfilePage> {
        ...
        body: BlocListener<AuthBloc, AuthenticateState>(
          listener: (context, state) {
            if (state.eventState == EventState.LOADED &&
              ...
              showToast(true, "Successfully updated");
            } else if (state.eventState == EventState.LOADED &&
                state.error == "Not updated") {
              showToast(false, "Error in updating. Please retry");
            }
          },
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (_formKey.currentState?.validate() ==
                                        ...
                                        if (hasInternet == false) {
                                          showToast(false, "No internet connexion");
                                        } else {
                                          if (password.isEmpty &&
                                              fullname.isNotEmpty) {
                                            setState(() {
                                              fullname =
                                                  fullnameTextEditing.text;
                                            });
  ...
  void showToast(bool updated, String content) =>
      Fluttertoast.showToast(
        msg: content,
        fontSize: 15,
        gravity: ToastGravity.TOP,
        backgroundColor: updated?Colors.green:Colors.redAccent,
